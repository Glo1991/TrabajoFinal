Imports CapaNE
Imports CapaLN
Public Class BuscarProductoPr
    Dim objStockLN As New StockLN
    Dim objStockNe As New ClaseStock
    Private Sub BuscarProductoPr_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        If resp = vbYes Then
            ...
            If dgvStock.CurrentRow.Selected = True Then
                ...
                RegistrarPrecios.TextBox2.Text = ds.Tables(0).Rows(0).Item(2).ToString
                Me.Close()

            End If
            RegistrarPrecios.idStoock = idStock
