Imports CapaLN
Imports CapaNE
Public Class BuscarClientePresupuesto
    Dim objUsuarioLN As New ClienteLN
    Dim objUsuarioNe As New ClaseCliente
    Public esfactura As Integer = 0
    Private Sub BuscarClientePresupuesto_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim objUsuarioLN As New ClienteLN
        Dim objUsuarioNe As New ClaseCliente
        ...
        If resp = vbYes Then
            ...
            If dgvAlumnas.CurrentRow.Selected = True Then
                ...
                If esfactura = 1 Then
                    ...
                    RegistrarVenta.TextBox1.Text = ds.Tables(0).Rows(0).Item(4).ToString
                    Dim ds1 As DataSet
                    Dim objVenta As New VentasLN
                    ds1 = objVenta.buscarPresupuesto(ds.Tables(0).Rows(0).Item(4).ToString)
                    If ds1.Tables(0).Rows.Count > 0 Then
                        RegistrarVenta.Button5.Visible = True
                    Else
                        RegistrarVenta.Button5.Visible = False
                    End If
                    Me.Close()
                Else
                    ...
                    NuevoPresupuestos.idAlumnaaa = idAlumna
                    Me.Close()
                End If
            End If
