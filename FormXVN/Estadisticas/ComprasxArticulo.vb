...
Public Class ComprasxArticulo
    ...
    Private Sub ComprasxArticulo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ds = objEst.CargarGrillaCompras(idcategoria, idmarca, fechadesde, fechahasta)
