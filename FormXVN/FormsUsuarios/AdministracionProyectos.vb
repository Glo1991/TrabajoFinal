Public Class AdministracionProyectos
    Private Sub AdministracionProyectos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        OFD.FileName = RutaDeaplicacion & "\Resources\Documentación - Adm Proy.pdf"
